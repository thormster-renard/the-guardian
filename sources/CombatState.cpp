...
void        CombatState::debutCombat()
{
  ...
  while (!endCombat)
	...
	std::cout << "Vous avez manque votre coups !" << std::endl;
      std::cout << "--------------------------------------------------------------------" << std::endl;
      std::cout << "  Chance de victoire : " << totalHitDef << " / 10" << std::endl;
      std::cout << "  Chance de toucher l'ennemi : " << chanceToucher << " / 10    Pourcentage d'attaque  : " << HitPercent << std::endl;
      std::cout << "  Chance de  parer  l'ennemi : " << defense << " / 10   Pourcentage de defense : " << defPercent << std::endl;
